...
- renders the gitignored `tools/environment/assets/selenium-grid/generated/config.toml` from the
  immutable tracked `tools/environment/assets/selenium-grid/config.toml` template (substitutes
  `__NETWORK__`);
